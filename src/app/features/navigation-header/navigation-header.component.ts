...
export class NavigationHeaderComponent {
  ...
  menu = [{option:"Home",isActive:true, path:'home'},
          ...
          {option:"Code Assignment",isActive:false, path:'/unavailable'},
          {option:"Revenue Management",isActive:false, path:'/unavailable'},
          {option:"Reports",isActive:false, path:'/unavailable'},
          {option:"Code Maintenance",isActive:false, path:'/unavailable'}];
