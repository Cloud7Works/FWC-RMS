...
export class FWCDataBackend implements APISignature{
    ...
    departmentDocumentSearch(type: any, payload: any) {        
        this.notification.notify.next(new APINotificationResult(Source.TransmittalSearch,new Status(false,false,'',Progress.InProgress),null));
    ...
    public getTransmittals() : Observable<TransmittalResponse[]>{       
        this.notification.notify.next(new APINotificationResult(Source.TransmittalSummary,new Status(false,false,'',Progress.InProgress),null));
        this.api = this.http.get(this.config.host+this.config
                                                        .endPoints
    ...
    public createTransmittal(transmittalDate : string, transmittalStatus : string) : Observable<TransmittalResponse>{        
        this.notification.notify.next(new APINotificationResult(Source.TransmittalCreation,new Status(false,false,'',Progress.InProgress),null));
        var payload = {
     ...
     public updateTransmittal(transmittalNumber : number ,payload : UpdateTransmittalRequest) :  Observable<TransmittalResponse>{      
        this.notification.notify.next(new APINotificationResult(Source.TransmittalUpdate,new Status(false,false,'',Progress.InProgress),null));    
    ...
    public deleteDepartmentDocRecord(transmittalNumber: number, departmentDocumentNumber:number) : Observable<any>{
        this.notification.notify.next(new APINotificationResult(Source.DeleteDepartmentDocument,new Status(false,false,'',Progress.InProgress),null));  
    ...
    public updateDeptDocRecord(transmittalNumber : number,deptDocNumber:number ,payload : CreateTransmittalDetailRequest,refRecord:TransmittalDetailModel) :  Observable<TransmittalDetailModel>{      
        this.notification.notify.next(new APINotificationResult(Source.UpdateDepartmentDocumentRecord,new Status(false,false,'',Progress.InProgress),null));      
        this.api = this.http.patch(this.config.host + this.config
                                                          .endPoints
    ...
    public getDeptDocRecord(transmittalNumber : number) :  Observable<TransmittalDetailModel>{      
        this.notification.notify.next(new APINotificationResult(Source.TransmittalList,new Status(false,false,'',Progress.InProgress),null));    
        this.api = this.http.get(this.config.host + this.config
                                                        .endPoints
